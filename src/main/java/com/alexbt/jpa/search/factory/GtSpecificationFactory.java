...
import com.alexbt.jpa.search.criteria.SearchCriteriaGt;
...
public class GtSpecificationFactory<T extends SearchCriteriaGt> implements SpecificationFactory<T, Number> {
    @Override
    public Predicate toPredicate(T searchCriteria, CriteriaBuilder builder, Path<Number> path) {
        ...
        return builder.gt(path, searchCriteria.getValue());
    }
}
